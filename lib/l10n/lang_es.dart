...
class LangEs extends Lang {
  ...
  @override
  String get psEFUISlogan => 'Crea aplicaciones para cualquiera';

  @override
  String get psEFUIDescription =>
      'NOTA: Esto fue traducido por IA\n\nEFUI es un paquete Flutter de código abierto que establece una base integral para la accesibilidad digital.\nEFUI ofrece un kit de inicio para cada pilar de la accesibilidad digital:';
  ...
  @override
  String get psScreen => '\nCumplimiento del lector de pantalla';
  ...
  String get psInternationalContent =>
      'Todo el texto externo de EFUI ha sido traducido al español. Con esto, EFUI ofrece una infraestructura bien organizada para futuras traducciones ilimitadas.';
  ...
  String get psResponsiveContent =>
      'EFUI está lleno de herramientas para ayudar en la construcción de aplicaciones que responden elegantemente al espacio de la pantalla. ¡Para verlo en acción, solo juega con la ventana de la aplicación que estás usando ahora!';
  ...
  String get tsGADescription =>
      'Realizó el trabajo de After Effects para la animación del logo de Empathetech LLC';

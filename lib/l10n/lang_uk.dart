...
class LangUk extends Lang {
  ...
  @override
  String get ouSimplifies => 'Це спрощує:';
  ...
  String get ouScreenContent =>
      'Застосунки YWT підтримують користувачів, яким потрібні ';
  ...
  String get ouInternationalContent =>
      'Додатки YWT (наразі) перекладено 14 мовами.\nOpen UI також забезпечує інфраструктуру для необмеженої кількості майбутніх перекладів.';
  ...
  String get vaPublished =>
      'Якщо ви опублікували застосунок із використанням Open UI, надішліть нам ';

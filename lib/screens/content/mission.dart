  ...
  StepStyle? _style(int indexTarget) {
    if (index > indexTarget) {
      ...
      return StepStyle(
        ...
        indexStyle: EzConfig.styles.labelLarge?.copyWith(color: EzConfig.colors.onSecondary),
      );
      ...
      return StepStyle(
        ...
        indexStyle: EzConfig.styles.labelLarge?.copyWith(color: EzConfig.colors.onPrimary),
      );
    } else {
      // Next
      return StepStyle(
        ...
        border: null,
        indexStyle: EzConfig.styles.labelLarge?.copyWith(color: EzConfig.colors.onSurface),
      );
    }
  }

  /// Defines [Stepper] navigation buttons
  List<Widget> stepButtons(Lang l10n, ControlsDetails details) => switch (details.stepIndex) {
        0 => <Widget>[
            EzTextIconButton(
              onPressed: details.onStepContinue,
              icon: EzIcon(Icons.arrow_downward),
              label: l10n.msSoWe,
            ),
          ],
        1 => <Widget>[
        ...
        2 || _ => <Widget>[
            EzTextIconButton(
              ...
              icon: EzIcon(Icons.arrow_upward),
              label: l10n.msFirst,
            ),
          ],
      };
          ...
          children: <Widget>[
            Expanded(
              child: Stepper(
                ...
                stepIconWidth: EzConfig.iconSize + EzConfig.padding,
                stepIconHeight: EzConfig.iconSize + EzConfig.padding,
            ...
            Container(
              alignment: EzConfig.isLTR ? Alignment.centerLeft : Alignment.centerRight,
              width: double.infinity,
              child: const EzFooter(textAlign: TextAlign.start),
            ),
          ],
        )),
